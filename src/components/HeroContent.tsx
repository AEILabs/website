      ...
      <div className="max-w-4xl mx-auto text-center px-6">
        ...
        >
          Economic Intelligence linking global trade and transport network models to national CGE and quantitative regional models, extended by local population embeddings
           — trace shocks from global to local, plan infrastructure at any scale, simulate the impact of economic policies, and reenvision your World — using agentic chat or expert interfaces.
        </motion.p>
